...
- A comment starting with =#= or two or more semicolons is just a comment, and
  all text until the end of line is ignored.  These comment characters do not
  have to be at the start of the line.
